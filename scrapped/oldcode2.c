...
//         for (int col = 0; col < width; col++) {
//                 for (int row = 0; row < height; row++) {
//                         Pnm_component_flt pixel = (Pnm_component_flt) methods->at(component_image, col, row);
//                         float pr = (float) ((Pnm_component_flt) pixel)->pr;
//                         float y = (float) ((Pnm_component_flt) pixel)->y;
//                         float pb = (float) ((Pnm_component_flt) pixel)->pb;
...
//                         Pnm_component_flt new_index = (Pnm_component_flt) methods->at(converted_image, col, row);
